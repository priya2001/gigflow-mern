    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center">
              ...
              <span className="ml-3 text-xl font-bold">GigFlow</span>
            </div>
            <p className="mt-4 text-gray-400 max-w-md">
              Connecting talented freelancers with businesses worldwide. Find the perfect talent for your next project.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li><Link to="#" className="text-base text-gray-400 hover:text-white">Blog</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li><Link to="#" className="text-base text-gray-400 hover:text-white">Help Center</Link></li>
              <li><Link to="#" className="text-base text-gray-400 hover:text-white">FAQ</Link></li>
              <li><Link to="#" className="text-base text-gray-400 hover:text-white">Terms of Service</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© 2026 GigFlow. All rights reserved.</p>
